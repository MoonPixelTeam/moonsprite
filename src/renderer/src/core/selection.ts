import type { CanvasAnchor, SelectionMask, SelectionMode, SelectionQuad, SelectionRect } from '@shared/types-selection'
import type { RasterLayer } from '@shared/types-layer'
import type { RgbaColor } from '@shared/types-color'
import type { SpriteDocument } from '@shared/types-document'
import { getPaletteEntry, rasterLayerPackedValueIsUniform } from './document-model'
