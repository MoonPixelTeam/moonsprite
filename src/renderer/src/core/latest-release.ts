  ...
  sections: [
    {
      ...
      items: [
        'latestRelease.item.animationTween',
        'latestRelease.item.referenceImages',
        'latestRelease.item.selectionAnchors',
        'latestRelease.item.timelineQuickActions'
      ]
    },
    {
      title: 'latestRelease.section.canvas',
      items: [
        'latestRelease.item.extensionAuthoring',
        'latestRelease.item.exportReliability',
        'latestRelease.item.editorReliability'
      ]
    }
  ]
} as const satisfies LatestReleaseDefinition
...
const beta4Release = {
  ...
  homeSummary: 'home.newsReleaseSummaryBeta4',
  sections: [
    {
      title: 'latestRelease.section.interaction',
      items: [
