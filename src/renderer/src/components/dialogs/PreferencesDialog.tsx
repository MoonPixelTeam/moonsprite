...
const PREFERENCE_SEARCH_KEYS: Record<PreferenceSection, TranslationKey[]> = {
  ...
  files: ['preferences.groups.locations', 'preferences.saveLocation', 'preferences.exportLocation', 'preferences.fixedSaveDirectory', 'preferences.fixedExportDirectory', 'preferences.groups.formats', 'preferences.saveFormat', 'preferences.saveOriginalFormat', 'preferences.saveOriginalFormatHint', 'preferences.exportFormat', 'preferences.groups.recovery', 'preferences.recovery', 'preferences.recoveryRetentionDays', 'preferences.recoveryRetentionDaysHint'],
