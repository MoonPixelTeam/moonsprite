...
const PREFERENCE_SEARCH_KEYS: Record<PreferenceSection, TranslationKey[]> = {
  ...
  editing: ['preferences.brushSizeWheelReversed', 'preferences.groups.zoom', 'preferences.wheelZoom', 'preferences.wheelZoomMode', 'preferences.zoomMode', 'preferences.viewDragSensitivity', 'preferences.position', 'preferences.canvasViewScrollbars', 'preferences.canvasViewScrollbarsHint', 'preferences.sections.editing', 'preferences.tablet.rightClick', 'preferences.tablet.rightClickHint', ...RIGHT_CLICK_ACTIONS.map((value) => value === 'foreground-eyedropper' ? 'preferences.tablet.rightClick.foreground' as const : `preferences.tablet.rightClick.${value}` as const)],
  ...
  files: ['preferences.groups.locations', 'preferences.saveDirectory', 'preferences.exportDirectory', 'preferences.groups.formats', 'preferences.saveFormat', 'preferences.saveOriginalFormat', 'preferences.saveOriginalFormatHint', 'preferences.exportFormat', 'preferences.groups.recovery', 'preferences.recovery', 'preferences.recoveryRetentionDays', 'preferences.recoveryRetentionDaysHint'],
