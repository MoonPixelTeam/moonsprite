    ...
    <div className="settings-layout"><aside className="preference-settings-sidebar"><div className="preference-sidebar-search"><TextInput className="preference-search" placeholder={t('preferences.search')} value={query} onChange={(event) => setQuery(event.target.value)} /></div><SettingsNavigation label={t('preferences.title')} value={section} items={visiblePreferenceSections.map(([value, labelKey]) => ({ value, label: t(labelKey), muted: Boolean(normalizedQuery && !preferenceSectionMatches.get(value)) }))} onChange={setSection} /></aside><PreferenceSearchContext.Provider value={preferenceSearch}><main className="component-scrollbar preference-settings-scroll">
      ...
      {section === 'cursor' && <>
        ...
        <PreferenceGroup title={t('preferences.paintingCursor')}>
          <FormField className="preference-field" label={t('preferences.paintingCursorShape')}><ThemedSelect value={preferences.paintingCursorShape} groups={[{ label: t('preferences.paintingCursorShape'), options: [{ value: 'cross', label: t('preferences.paintingCursor.cross') }, { value: 'dot', label: t('preferences.paintingCursor.dot') }] }]} label={t('preferences.paintingCursorShape')} onChange={value => update('paintingCursorShape', value as typeof preferences.paintingCursorShape)} /></FormField>
          <FormField className="preference-field" label={t('preferences.paintingCursorType')}><ThemedSelect value={preferences.paintingCursorType} groups={[{ label: t('preferences.paintingCursorType'), options: [{ value: 'simple', label: t('preferences.paintingCursor.simple') }, { value: 'sprite', label: t('preferences.paintingCursor.sprite') }, { value: 'sprite-unscaled', label: t('preferences.paintingCursor.unscaled') }] }]} label={t('preferences.paintingCursorType')} onChange={value => update('paintingCursorType', value as typeof preferences.paintingCursorType)} /></FormField>
