import type { ExportProtection } from '@/core/export-protection'
...
import {
  ...
  type ToolIconScale,
  type TabletApi,
  type TabletBarrelButtonAction,
  type TabletTouchMode,
  type UiMotionLevel,
  type UiScale,
...
export const PREFERENCE_SEARCH_KEYS: Record<PreferenceSection, TranslationKey[]> = {
  general: ['preferences.groups.interface', 'preferences.groups.project', 'preferences.language', 'preferences.uiScale', 'preferences.bodyFontSize', 'preferences.toolIconScale', 'preferences.animations', 'preferences.timelapseRecording', 'preferences.diagnostics.mode', 'preferences.diagnostics.off', 'preferences.diagnostics.memory', 'preferences.diagnostics.full', 'preferences.diagnostics.lag', 'canvas.keyDisplay', 'preferences.animationsGroup', 'preferences.animationsHint', 'preferences.animationsLevel.full', 'preferences.animationsLevel.fullHint', 'preferences.animationsLevel.normal', 'preferences.animationsLevel.normalHint', 'preferences.animationsLevel.off', 'preferences.animationsLevel.offHint', 'preferences.animationsLevel.subtle', 'preferences.animationsLevel.subtleHint', 'preferences.bodyFontSizeGroup', 'preferences.bodyFontSizeOptionHint', 'preferences.interactionHints', 'preferences.keyDisplayDuration', 'preferences.keyDisplayHint', 'preferences.keyDisplaySize', 'preferences.languageGroup', 'preferences.timelapseRecordingHint', 'preferences.toolIconScale.large', 'preferences.toolIconScale.normal', 'preferences.toolIconScaleGroup', 'preferences.tooltips', 'preferences.tooltipsHint', 'preferences.uiScaleFractionalHint', 'preferences.uiScaleGroup', 'preferences.usageStatisticsEnabled'],
  quickCommands: ['preferences.sections.quickCommands', 'preferences.groups.quickCommandLayout', 'preferences.quickCommandBar', 'preferences.quickCommandBarTranslucent', 'preferences.quickCommandBarTranslucentHint', 'preferences.quickCommandOrderHint', 'preferences.quickCommandBarName', 'preferences.quickCommandBarEdge', ...QUICK_COMMAND_SEARCH_KEYS, 'preferences.quickCommandBarHint', 'preferences.quickCommandDefaultName', 'preferences.quickCommandEnabledAria', 'preferences.restoreDefaults'],
  appearance: ['preferences.groups.canvas', 'preferences.checkerSize', 'preferences.checkerColors', 'preferences.lightColor', 'preferences.darkColor', 'preferences.pixelGridColor', 'preferences.gridColor', 'preferences.sliceColor', 'preferences.freeTileInstanceOutlineColor', 'preferences.textBoxColor', 'preferences.canvasResizeColor', 'preferences.luminanceScope', 'preferences.luminanceScope.app', 'preferences.luminanceScope.canvas', 'preferences.luminanceScopeGroup', 'preferences.theme.restore'],
  theme: ['preferences.theme.followSystem', 'preferences.theme.followSystemHint', 'preferences.groups.theme', 'preferences.theme.available', 'preferences.theme.current'],
  cursor: ['preferences.nativeCursor', 'preferences.nativeCursorHint', 'preferences.uiCursor', 'preferences.paintingCursor', 'preferences.paintingCursorAlignToPixel', 'preferences.paintingCursor.pixelCross', 'preferences.paintingCursorShape', 'preferences.paintingCursor.cross', 'preferences.paintingCursor.dot', 'preferences.selectionSizeVisible', 'preferences.groups.cursor', 'preferences.localCursor', 'preferences.cursorScale', 'preferences.groups.previews', 'preferences.brushPreview', 'preferences.brushPreview.none', 'preferences.brushPreview.edge', 'preferences.brushPreview.full', 'preferences.brushPreview.fullEdge', 'preferences.drawingBrushPreview', 'preferences.selectionCrosshair', 'preferences.selectionPreviewColor', 'preferences.selectionPreviewColor.auto', 'preferences.selectionPreviewColor.custom', 'preferences.selectionPreviewCustomColor', 'preferences.groups.cursorAppearance', 'preferences.cursorColor', 'preferences.cursorColorGroup', 'preferences.cursorColor.auto', 'preferences.cursorColor.custom', 'preferences.brushEdgeThickness', 'preferences.brushPreviewGroup', 'preferences.cursorScaleGroup', 'preferences.localCursorHint', 'preferences.selectionPreviewColorGroup'],
  editing: ['preferences.sections.editing', 'preferences.brushSizeWheelReversed', 'preferences.tablet.rightClick', 'preferences.tablet.rightClickHint', ...RIGHT_CLICK_ACTIONS.map((value) => value === 'foreground-eyedropper' ? 'preferences.tablet.rightClick.foreground' as const : `preferences.tablet.rightClick.${value}` as const), 'preferences.groups.paste', 'preferences.pasteTarget', 'preferences.pasteTargetHint', 'preferences.pasteTarget.currentCell', 'preferences.pasteTarget.newLayer', 'preferences.pasteTarget.newProject', 'preferences.groups.zoom', 'preferences.wheelZoom', 'preferences.wheelZoomMode', 'preferences.zoomMode', 'preferences.viewDragSensitivity', 'preferences.position', 'preferences.canvasViewScrollbars', 'preferences.canvasViewScrollbarsHint', 'preferences.position.canvas', 'preferences.position.pointerLeft', 'preferences.position.view', 'preferences.positionGroup', 'preferences.referenceScaling', 'preferences.referenceScaling.pixelated', 'preferences.referenceScaling.smooth', 'preferences.viewDragSensitivityGroup', 'preferences.wheelZoomMode.smooth', 'preferences.wheelZoomMode.stepped', 'preferences.wheelZoomModeGroup', 'preferences.zoomMode.smooth', 'preferences.zoomMode.stepped', 'preferences.zoomModeGroup'],
  tablet: ['preferences.groups.tablet', 'preferences.tablet.api', 'preferences.tablet.touchMode', 'preferences.tablet.pressure', 'preferences.tablet.eraserTip', 'preferences.tablet.barrelButton', 'preferences.tablet.twoFingerZoom', 'preferences.tablet.twoFingerRotate', 'preferences.tablet.tilt', 'preferences.tablet.twist', 'preferences.tablet.api.auto', 'preferences.tablet.api.disabled', 'preferences.tablet.api.windowsInk', 'preferences.tablet.apiGroup', 'preferences.tablet.apiHint', 'preferences.tablet.barrelButton.disabled', 'preferences.tablet.barrelButton.eraser', 'preferences.tablet.barrelButton.eyedropper', 'preferences.tablet.barrelButton.hand', 'preferences.tablet.barrelButtonGroup', 'preferences.tablet.pressureHint', 'preferences.tablet.touchMode.disabled', 'preferences.tablet.touchMode.draw', 'preferences.tablet.touchMode.navigate', 'preferences.tablet.touchModeGroup'],
  tools: ['preferences.restoreDefaults', 'tools.toolbar', 'home.reorderHint', 'preferences.groups.previews', 'preferences.moveLayerContentPreview', 'preferences.moveLayerClickFlash', 'preferences.moveLayerClickFlashDuration', 'preferences.groups.alignment', 'preferences.gridAlignment', 'preferences.gridAlignmentHint', 'preferences.smartAlignment', 'preferences.smartAlignmentHint', 'preferences.alignmentGuides', 'preferences.alignmentGuidesHint', 'preferences.alignmentThreshold', 'preferences.alignmentThresholdHint', 'preferences.groups.drawing', 'preferences.gradientLineVisible', 'preferences.gradientLineColor', 'preferences.shiftLinePreview', 'preferences.balancedLine', 'preferences.balancedLineHint', 'preferences.optimizedRotation', 'preferences.optimizedRotationHint', 'preferences.lineDirectionStep', 'preferences.lassoClosed', 'preferences.eyedropperPencil', 'preferences.groups.eyedropper', 'preferences.eyedropperQuickSelect', 'preferences.eyedropperMagnifier', 'preferences.eyedropperMagnifierSize', 'preferences.eyedropperMagnifierStyle', 'preferences.eyedropperMagnifierDistortion', 'preferences.eyedropperMagnifierDistortionHint', 'preferences.eyedropperMagnifierHint', 'preferences.eyedropperMagnifierSizeGroup', 'preferences.eyedropperMagnifierStyle.line', 'preferences.eyedropperMagnifierStyle.pixel', 'preferences.eyedropperMagnifierStyleGroup', 'preferences.eyedropperMagnifierStyleHint', 'preferences.eyedropperQuickSelectHint', 'preferences.lineDirectionStepHint', 'preferences.moveLayerClickFlashDurationGroup', 'preferences.moveLayerClickFlashDurationHint', 'preferences.moveLayerClickFlashHint', 'preferences.moveLayerContentPreviewHint'],
  undo: ['preferences.groups.undo', 'preferences.historyLimitEnabled', 'preferences.historyLimitEnabledHint', 'preferences.historyLimit', 'preferences.historyLimitHint', 'preferences.groups.localHistory', 'preferences.localHistoryEnabled', 'preferences.localHistoryHint', 'preferences.localHistoryLimit', 'preferences.localHistoryLimitHint'],
  files: ['preferences.exportProtection.title', 'preferences.exportProtection.off', 'preferences.exportProtection.blur', 'preferences.exportProtection.noise', 'preferences.exportProtection.hint', 'preferences.groups.locations', 'preferences.saveLocation', 'preferences.exportLocation', 'preferences.fixedSaveDirectory', 'preferences.fixedExportDirectory', 'preferences.groups.formats', 'preferences.saveFormat', 'preferences.saveOriginalFormat', 'preferences.saveOriginalFormatHint', 'preferences.exportFormat', 'preferences.groups.recovery', 'preferences.recovery', 'preferences.recoveryRetentionDays', 'preferences.recoveryRetentionDaysHint', 'preferences.chooseDirectory', 'preferences.chooseExportDirectory', 'preferences.chooseProjectBackupDirectory', 'preferences.chooseSaveDirectory', 'preferences.customDirectoryHint', 'preferences.daysSuffix', 'preferences.defaultBackupDirectory', 'preferences.defaultBackupDirectoryHint', 'preferences.directory.custom', 'preferences.directory.default', 'preferences.exportFormatGroup', 'preferences.location.fixed', 'preferences.location.recent', 'preferences.projectBackupDirectory', 'preferences.projectBackupEnabled', 'preferences.projectBackupHint', 'preferences.projectBackupRetention', 'preferences.projectBackupVersions', 'preferences.projectBackupVersionsHint', 'preferences.recovery.minutes1', 'preferences.recovery.minutes10', 'preferences.recovery.minutes2', 'preferences.recovery.minutes5', 'preferences.recovery.off', 'preferences.recovery.seconds30', 'preferences.recoveryGroup', 'preferences.resetProjectBackupDirectory', 'preferences.restoreDefaultDirectory', 'preferences.restoreDefaultExportDirectory', 'preferences.restoreDefaultSaveDirectory', 'preferences.saveFormatGroup'],
  colorLayers: ['preferences.recentColorsVisible', 'preferences.colorModes', 'preferences.restoreDefaults', 'preferences.pixelFormat', 'preferences.pixelFormatHint', ...PIXEL_FORMATS.map((format) => `preferences.pixelFormat.${format}` as const)],
  presets: ['preferences.newDocumentPresets', 'preferences.addSize', 'preferences.exportScalePresets', 'preferences.addScale', 'preferences.layerColors', 'preferences.addColor', 'preferences.restoreDefaults', 'preferences.deleteLayerColorAria', 'preferences.deleteScaleAria', 'preferences.deleteSizeAria', 'preferences.exportScaleAria', 'preferences.layerColorAria', 'preferences.presetHeightAria', 'preferences.presetWidthAria'],
  extensions: ['preferences.groups.extensions', 'app.menu.file.scripts', 'preferences.extensions.add', 'preferences.extensions.openFolder', 'preferences.extensions.empty', 'preferences.extensions.entry', 'preferences.extensions.commands', 'preferences.extensions.panels', 'preferences.extensions.menus', 'preferences.extensions.enabled', 'preferences.extensions.disabled', 'preferences.extensions.enable', 'preferences.extensions.disable', 'preferences.extensions.uninstall', 'app.menu.file.loadingScripts', 'app.menu.file.noScripts', 'app.menu.file.openScriptFolder', 'preferences.extensions.loading', 'preferences.extensions.versionShort', 'preferences.scripts.deleteAria', 'preferences.scripts.extensionManaged'],
...
export function PreferencesDialog({ initialSection = 'general', onClose, onPresetChange, onChooseAndInstallExtension }: PreferencesDialogProps) {
  ...
  const resetAllSettings = async (): Promise<void> => {
    ...
    clearStoredValuesExcept([RECENT_PROJECTS_STORAGE_KEY, GALLERY_PINS_STORAGE_KEY, ...WORKSPACE_LAYOUT_STORAGE_KEYS], undefined, ['moonsprite.extension-runtime.v1.'])
    setEditorPreferencesPreview(null)
  ...
  const preferenceSectionMatches = useMemo(() => new Map(PREFERENCE_SECTIONS.map(([value, labelKey]) => [value, !normalizedQuery || [t(labelKey), ...PREFERENCE_SEARCH_KEYS[value].map((key) => t(key)), ...(value === 'general' ? [t('preferences.interactionHints'), t('preferences.tooltips'), t('canvas.keyDisplay'), t('preferences.keyDisplayFunction'), t('preferences.keyDisplaySize'), t('preferences.keyDisplayDuration')] : [])].some((label) => label.toLocaleLowerCase(locale).includes(normalizedQuery))])), [locale, normalizedQuery, t])
    ...
    <div className="settings-layout"><aside className="preference-settings-sidebar"><div className="preference-sidebar-search"><TextInput className="preference-search" placeholder={t('preferences.search')} value={query} onChange={(event) => setQuery(event.target.value)} /></div><SettingsNavigation label={t('preferences.title')} value={section} items={visiblePreferenceSections.map(([value, labelKey]) => ({ value, label: t(labelKey), muted: Boolean(normalizedQuery && !preferenceSectionMatches.get(value)) }))} onChange={setSection} /></aside><PreferenceSearchContext.Provider value={preferenceSearch}><main className="component-scrollbar preference-settings-scroll">
      {section === 'general' && <>
        <PreferenceGroup title={t('preferences.groups.interface')}>
          ...
          <FormField className="preference-field" label={t('preferences.bodyFontSize')}><ThemedSelect value={String(preferences.bodyFontScale)} groups={[{ label: t('preferences.bodyFontSizeGroup'), options: BODY_FONT_SCALE_VALUES.map((value) => ({ value: String(value), label: `${Math.round(value * 100)}%`, description: t('preferences.bodyFontSizeOptionHint', { size: Math.round(13 * value) }) })) }]} label={t('preferences.bodyFontSize')} onChange={(value) => update('bodyFontScale', Number(value) as BodyFontScale)} /></FormField>
          ...
          <FormField className="preference-field" label={t('preferences.animations')} tooltip={t('preferences.animationsHint')}><ThemedSelect value={preferences.uiMotionLevel} groups={[{ label: t('preferences.animationsGroup'), options: [
        ...
        <PreferenceGroup title={t('preferences.interactionHints')}>
          <PreferenceToggle label={t('preferences.tooltips')} checked={preferences.tooltipsEnabled} onChange={(enabled) => update('tooltipsEnabled', enabled)} tooltip={t('preferences.tooltipsHint')} />
          {toggle(t('canvas.keyDisplay'), preferences.keyDisplayEnabled, (value) => update('keyDisplayEnabled', value), t('preferences.keyDisplayHint'))}
          {preferences.keyDisplayEnabled && <>
            {toggle(t('preferences.keyDisplayFunction'), preferences.keyDisplayFunction, (value) => update('keyDisplayFunction', value), t('preferences.keyDisplayFunctionHint'))}
            <FormField className="preference-field" label={t('preferences.keyDisplaySize')}><ThemedSelect value={String(preferences.keyDisplaySize)} groups={[{ label: t('preferences.keyDisplaySize'), options: [{ value: '0.75', label: t('common.small') }, { value: '1.3', label: t('timelapse.qualityMedium') }, { value: '1.9', label: t('layers.density.large') }, { value: '2.5', label: t('layers.density.huge') }] }]} label={t('preferences.keyDisplaySize')} onChange={(value) => update('keyDisplaySize', Number(value))} /></FormField>
            <FormField className="preference-field" label={t('preferences.keyDisplayDuration')}><ThemedSelect value={String(preferences.keyDisplayDuration)} groups={[{ label: t('preferences.keyDisplayDuration'), options: KEY_DISPLAY_DURATIONS.map((duration) => ({ value: String(duration), label: t('usageStats.seconds', { count: duration / 1000 }) })) }]} label={t('preferences.keyDisplayDuration')} onChange={(value) => update('keyDisplayDuration', Number(value) as KeyDisplayDuration)} /></FormField>
          </>}
        </PreferenceGroup>
        ...
        <PreferenceGroup title={t('usageStats.title')}>
          <PreferenceToggle label={t('preferences.usageStatisticsEnabled')} checked={usageStatisticsEnabled} disabled={usageStatisticsBusy} onChange={(enabled) => void runUsageStatistics(async () => { await setUsageStatisticsEnabled(enabled); setUsageStatisticsEnabledState(enabled) })} />
        </PreferenceGroup>
      ...
      {section === 'cursor' && <>
        <PreferenceGroup title={t('preferences.uiCursor')}>
          {toggle(t('preferences.nativeCursor'), preferences.useLocalCursors, (value) => update('useLocalCursors', value), t('preferences.nativeCursorHint'))}
          {!preferences.useLocalCursors && <FormField className="preference-field" label={t('preferences.cursorScale')}><ThemedSelect value={String(preferences.cursorScale)} groups={[{ label: t('preferences.cursorScaleGroup'), options: [{ value: '1', label: '100%' }, ...(preferences.cursorScale === 1.25 || preferences.cursorScale === 1.5 ? [{ value: String(preferences.cursorScale), label: `${preferences.cursorScale * 100}%` }] : []), { value: '2', label: '200%' }, { value: '3', label: '300%' }, { value: '4', label: '400%' }] }]} label={t('preferences.cursorScale')} onChange={(value) => update('cursorScale', Number(value) as CursorScale)} /></FormField>}
        </PreferenceGroup>
        <PreferenceGroup title={t('preferences.paintingCursor')}>
          <FormField className="preference-field" label={t('preferences.paintingCursorShape')}><ThemedSelect value={preferences.paintingCursorShape} groups={[{ label: t('preferences.paintingCursorShape'), options: [{ value: 'cross', label: t('preferences.paintingCursor.cross') }, { value: 'dot', label: t('preferences.paintingCursor.dot') }, { value: 'pixel-cross', label: t('preferences.paintingCursor.pixelCross') }] }]} label={t('preferences.paintingCursorShape')} onChange={value => update('paintingCursorShape', value as typeof preferences.paintingCursorShape)} /></FormField>
          <PreferenceToggle label={t('preferences.paintingCursorAlignToPixel')} checked={preferences.paintingCursorAlignToPixel} onChange={() => update('paintingCursorAlignToPixel', !preferences.paintingCursorAlignToPixel)} />
        ...
        <PreferenceGroup title={t('preferences.groups.previews')}>
          ...
          {preferences.brushPreviewMode === 'full-edge' && <FormField className="preference-field" label={t('preferences.brushEdgeThickness')}><NumberInput aria-label={t('preferences.brushEdgeThickness')} min={1} max={8} suffix="px" value={preferences.brushEdgeThickness} onValueChange={(brushEdgeThickness) => update('brushEdgeThickness', Math.round(brushEdgeThickness))} /></FormField>}
      ...
      {section === 'editing' && <>
        <PreferenceGroup title={t('preferences.sections.editing')}>
          {toggle(t('preferences.brushSizeWheelReversed'), preferences.brushSizeWheelReversed, (value) => update('brushSizeWheelReversed', value))}
        ...
        <PreferenceGroup title={t('preferences.groups.paste')}>
          <FormField className="preference-field" label={t('preferences.pasteTarget')} tooltip={t('preferences.pasteTargetHint')}><ThemedSelect<PasteTarget> value={preferences.pasteTarget} groups={[{ label: t('preferences.pasteTarget'), options: [{ value: 'current-cell', label: t('preferences.pasteTarget.currentCell') }, { value: 'new-layer', label: t('preferences.pasteTarget.newLayer') }, { value: 'new-project', label: t('preferences.pasteTarget.newProject') }] }]} label={t('preferences.pasteTarget')} onChange={(value) => update('pasteTarget', value)} /></FormField>
        </PreferenceGroup>
        <PreferenceGroup title={t('preferences.groups.zoom')}>
          <FormField className="preference-field" label={t('preferences.referenceScaling')}><ThemedSelect<'smooth' | 'pixelated'> value={preferences.referenceScaling} groups={[{ label: t('preferences.referenceScaling'), options: [{ value: 'smooth', label: t('preferences.referenceScaling.smooth') }, { value: 'pixelated', label: t('preferences.referenceScaling.pixelated') }] }]} label={t('preferences.referenceScaling')} onChange={(value) => update('referenceScaling', value)} /></FormField>
      ...
      {section === 'tablet' && <PreferenceGroup title={t('preferences.groups.tablet')}>
          <FormField className="preference-field" label={t('preferences.tablet.api')} tooltip={t('preferences.tablet.apiHint')}><ThemedSelect value={preferences.tablet.api} groups={[{ label: t('preferences.tablet.apiGroup'), options: [{ value: 'auto', label: t('preferences.tablet.api.auto') }, { value: 'windows-ink', label: t('preferences.tablet.api.windowsInk') }, { value: 'disabled', label: t('preferences.tablet.api.disabled') }] }]} label={t('preferences.tablet.api')} onChange={(value) => update('tablet', { ...preferences.tablet, api: value as TabletApi })} /></FormField>
          <FormField className="preference-field" label={t('preferences.tablet.touchMode')}><ThemedSelect value={preferences.tablet.touchMode} groups={[{ label: t('preferences.tablet.touchModeGroup'), options: [{ value: 'navigate', label: t('preferences.tablet.touchMode.navigate') }, { value: 'draw', label: t('preferences.tablet.touchMode.draw') }, { value: 'disabled', label: t('preferences.tablet.touchMode.disabled') }] }]} label={t('preferences.tablet.touchMode')} onChange={(value) => update('tablet', { ...preferences.tablet, touchMode: value as TabletTouchMode })} /></FormField>
      ...
      {section === 'tools' && <>
        ...
        <PreferenceGroup title={t('preferences.groups.alignment')}>
          ...
          {(preferences.gridAlignmentEnabled || preferences.smartAlignmentEnabled) && <FormField className="preference-field" label={t('preferences.alignmentThreshold')} tooltip={t('preferences.alignmentThresholdHint')}><NumberInput aria-label={t('preferences.alignmentThreshold')} min={1} max={32} suffix="px" value={preferences.alignmentThreshold} onValueChange={(value) => update('alignmentThreshold', parseAlignmentThreshold(String(value)))} /></FormField>}
        </PreferenceGroup>
      ...
      {section === 'undo' && <>
        <PreferenceGroup title={t('preferences.groups.undo')}>
        {toggle(t('preferences.historyLimitEnabled'), preferences.historyLimitEnabled, (value) => update('historyLimitEnabled', value), t('preferences.historyLimitEnabledHint'))}
        {preferences.historyLimitEnabled && <FormField className="preference-field" label={t('preferences.historyLimit')} tooltip={t('preferences.historyLimitHint')}><NumberInput min={1} max={10000} suffix={t('common.itemsSuffix')} value={preferences.historyLimit} onValueChange={(value) => update('historyLimit', Math.round(value))} /></FormField>}
        </PreferenceGroup>
        <PreferenceGroup title={t('preferences.groups.localHistory')}>
        {toggle(t('preferences.localHistoryEnabled'), preferences.localHistoryEnabled, (value) => update('localHistoryEnabled', value), t('preferences.localHistoryHint'))}
        {preferences.localHistoryEnabled && <FormField className="preference-field" label={t('preferences.localHistoryLimit')} tooltip={t('preferences.localHistoryLimitHint')}><NumberInput min={1} max={200} suffix={t('common.itemsSuffix')} value={preferences.localHistoryLimit} onValueChange={(value) => update('localHistoryLimit', Math.round(value))} /></FormField>}
        </PreferenceGroup>
      </>}
      {section === 'files' && <>
        <PreferenceGroup title={t('preferences.exportProtection.title')}>
          <FormField className="preference-field" label={t('preferences.exportProtection.title')} tooltip={t('preferences.exportProtection.hint')}>
            <ThemedSelect value={preferences.exportProtection} label={t('preferences.exportProtection.title')} groups={[{ label: t('preferences.exportProtection.title'), options: [
              { value: 'off', label: t('preferences.exportProtection.off') },
              { value: 'blur', label: t('preferences.exportProtection.blur') },
              { value: 'blur-noise', label: t('preferences.exportProtection.noise') }
            ] }]} onChange={value => update('exportProtection', value as ExportProtection)} />
          </FormField>
        </PreferenceGroup>
        <PreferenceGroup title={t('preferences.groups.locations')}>
        <FormField className="preference-field" label={t('preferences.saveLocation')}><ThemedSelect value={preferences.saveLocationMode} groups={[{ label: t('preferences.saveLocation'), options: [{ value: 'recent', label: t('preferences.location.recent') }, { value: 'fixed', label: t('preferences.location.fixed') }] }]} label={t('preferences.saveLocation')} onChange={(value) => update('saveLocationMode', value)} /></FormField>
        {preferences.saveLocationMode === 'fixed' && <FormField className="preference-field preference-path-field" label={t('preferences.fixedSaveDirectory')} tooltip={preferences.saveDirectory ? t('preferences.directory.custom') : t('preferences.directory.default')}><div className="preference-path-control"><TextInput readOnly value={preferences.saveDirectory || defaultDirectories.saveDirectory} title={preferences.saveDirectory || defaultDirectories.saveDirectory} /><button type="button" className="icon-button" title={t('preferences.chooseDirectory')} aria-label={t('preferences.chooseSaveDirectory')} onClick={() => void choosePreferenceDirectory('saveDirectory')}><PixelUtilityIcon kind="folderOpen" /></button><button type="button" className="icon-button" title={t('preferences.restoreDefaultDirectory')} aria-label={t('preferences.restoreDefaultSaveDirectory')} disabled={!preferences.saveDirectory} onClick={() => update('saveDirectory', '')}><PixelUtilityIcon kind="restore" /></button></div></FormField>}
        <FormField className="preference-field" label={t('preferences.exportLocation')}><ThemedSelect value={preferences.exportLocationMode} groups={[{ label: t('preferences.exportLocation'), options: [{ value: 'recent', label: t('preferences.location.recent') }, { value: 'fixed', label: t('preferences.location.fixed') }] }]} label={t('preferences.exportLocation')} onChange={(value) => update('exportLocationMode', value)} /></FormField>
        {preferences.exportLocationMode === 'fixed' && <FormField className="preference-field preference-path-field" label={t('preferences.fixedExportDirectory')} tooltip={preferences.exportDirectory ? t('preferences.directory.custom') : t('preferences.directory.default')}><div className="preference-path-control"><TextInput readOnly value={preferences.exportDirectory || defaultDirectories.exportDirectory} title={preferences.exportDirectory || defaultDirectories.exportDirectory} /><button type="button" className="icon-button" title={t('preferences.chooseDirectory')} aria-label={t('preferences.chooseExportDirectory')} onClick={() => void choosePreferenceDirectory('exportDirectory')}><PixelUtilityIcon kind="folderOpen" /></button><button type="button" className="icon-button" title={t('preferences.restoreDefaultDirectory')} aria-label={t('preferences.restoreDefaultExportDirectory')} disabled={!preferences.exportDirectory} onClick={() => update('exportDirectory', '')}><PixelUtilityIcon kind="restore" /></button></div></FormField>}
        </PreferenceGroup>
        <PreferenceGroup title={t('preferences.groups.formats')}>
        {toggle(t('preferences.saveOriginalFormat'), preferences.saveOriginalFormat, (value) => update('saveOriginalFormat', value), t('preferences.saveOriginalFormatHint'))}
        <FormField className="preference-field" label={t('preferences.saveFormat')}><ThemedSelect value={preferences.saveFormat} groups={[{ label: t('preferences.saveFormatGroup'), options: [{ value: 'moonsprite', label: '.moonsprite' }, { value: 'png', label: '.png' }, { value: 'jpeg', label: '.jpg / .jpeg' }, { value: 'webp', label: '.webp' }, { value: 'svg', label: '.svg' }, { value: 'ico', label: '.ico' }, { value: 'psd', label: '.psd' }, { value: 'ase', label: '.ase' }, { value: 'aseprite', label: '.aseprite' }] }]} label={t('preferences.saveFormat')} onChange={(value) => update('saveFormat', value)} /></FormField>
        <FormField className="preference-field" label={t('preferences.exportFormat')}><ThemedSelect value={preferences.exportFormat} groups={[{ label: t('preferences.exportFormatGroup'), options: [{ value: 'png', label: 'PNG' }, { value: 'jpeg', label: 'JPEG' }, { value: 'webp', label: 'WebP' }, { value: 'svg', label: 'SVG' }, { value: 'gif', label: 'GIF' }, { value: 'bmp', label: 'BMP (.bmp)' }, { value: 'ico', label: 'ICO (.ico)' }, { value: 'psd', label: 'PSD' }] }]} label={t('preferences.exportFormat')} onChange={(value) => update('exportFormat', value)} /></FormField>
        ...
        <FormField className="preference-field" label={t('preferences.recoveryRetentionDays')} tooltip={t('preferences.recoveryRetentionDaysHint')}><NumberInput min={1} max={365} suffix={t('preferences.daysSuffix')} value={preferences.recoveryRetentionDays} onValueChange={(value) => update('recoveryRetentionDays', Math.round(value))} /></FormField>
        </PreferenceGroup>
        <PreferenceGroup title={t('home.projectBackups')}>
        {toggle(t('preferences.projectBackupEnabled'), preferences.projectBackupEnabled, (value) => update('projectBackupEnabled', value), t('preferences.projectBackupHint'))}
        {preferences.projectBackupEnabled && <>
          <FormField className="preference-field" label={t('preferences.projectBackupVersions')} tooltip={t('preferences.projectBackupVersionsHint')}><NumberInput min={1} max={10} suffix={t('common.countSuffix')} value={preferences.projectBackupVersions} onValueChange={(value) => update('projectBackupVersions', Math.round(value))} /></FormField>
          <FormField className="preference-field" label={t('preferences.projectBackupRetention')}><NumberInput min={1} max={365} suffix={t('preferences.daysSuffix')} value={preferences.projectBackupRetentionDays} onValueChange={(value) => update('projectBackupRetentionDays', Math.round(value))} /></FormField>
          <FormField className="preference-field preference-path-field" label={t('preferences.projectBackupDirectory')} tooltip={preferences.projectBackupDirectory ? t('preferences.customDirectoryHint') : t('preferences.defaultBackupDirectoryHint')}><div className="preference-path-control"><TextInput readOnly value={preferences.projectBackupDirectory || t('preferences.defaultBackupDirectory')} title={preferences.projectBackupDirectory || t('preferences.defaultBackupDirectory')} /><button type="button" className="icon-button" title={t('preferences.chooseDirectory')} aria-label={t('preferences.chooseProjectBackupDirectory')} onClick={() => void choosePreferenceDirectory('projectBackupDirectory')}><PixelUtilityIcon kind="folderOpen" /></button><button type="button" className="icon-button" title={t('preferences.restoreDefaultDirectory')} aria-label={t('preferences.resetProjectBackupDirectory')} disabled={!preferences.projectBackupDirectory} onClick={() => update('projectBackupDirectory', '')}><PixelUtilityIcon kind="restore" /></button></div></FormField>
        </>}
        </PreferenceGroup>
      </>}
      {section === 'colorLayers' && <div className="preference-presets preference-color-layer-settings"><PreferenceGroup title={t('color.recentColors')}>{toggle(t('preferences.recentColorsVisible'), preferences.recentColorsVisible, value => update('recentColorsVisible', value))}</PreferenceGroup><PreferenceGroup title={t('preferences.pixelFormat')}>
