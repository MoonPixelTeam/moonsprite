...
import { compositeRegion, DocumentCompositeCache, expandLayerStyleInvalidationRect, type CompositeStackItem } from '@/core/document-composite'
...
import { selectionTransformPreviewPacked, selectionTransformPreviewRasterPacked, type SelectionTransformSource } from '@/core/tools-selection-transform'
