...
| { kind: 'cel'; button: 0 | 2; sourceAnchorKey: string; cellKeys: string[]; groupCellKeys?: string[]; pointerAnchorKey?: string; preserveSelection: boolean; selectionMode?: 'toggle' | 'range'; startX: number; startY: number; moved: boolean; canMove: boolean; pendingSelection: boolean; longPressed: boolean; longPressTimer: number | null; lastSelectionTarget: string }
