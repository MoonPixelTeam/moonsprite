import type { AnimationCel, AnimationCelSurface, AnimationGroupMask, LayerGroup, RasterLayer, SpriteDocument } from '@shared/types'
...
import { createCompositePointSampler, createId, createLayer, createLayerMask, isLayerEffectivelyLocked, layerContentBounds, paletteColorIdForCanvas, resolveLayerCanvasColor } from '@/core/document'
