...
export const copyCanvasToolSettings = (source: DocumentSession, target: DocumentSession): void => {
  Object.assign(target, {
    ...
    drawingAnchor: { ...source.drawingAnchor },
    drawingAnchorVisible: source.drawingAnchorVisible,
    drawFromCanvasCenter: source.drawFromCanvasCenter,
...
export function persistToolSettings(session: DocumentSession): void {
  ...
  const snapshot: PersistedToolSettings = {
    ...
    drawingAnchor: { ...session.drawingAnchor },
    drawingAnchorVisible: session.drawingAnchorVisible,
    drawFromCanvasCenter: session.drawFromCanvasCenter,
...
export const sessionFromDocument = (document: SpriteDocument): DocumentSession => {
  ...
  const session = {
    ...
    drawingAnchor: { ...settings.drawingAnchor },
    drawingAnchorVisible: settings.drawingAnchorVisible,
    drawFromCanvasCenter: settings.drawFromCanvasCenter,
