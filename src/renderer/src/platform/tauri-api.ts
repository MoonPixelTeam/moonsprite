...
const createBrowserApi = (): MoonSpriteApi => ({
  ...
  saveUsageStatisticsFile: async () => ({ canceled: true }),
  ...
  readExtensionPetSprite: async () => { throw new Error(tr('platform.browser.readUnsupported')) },
  showExtensionPet: async () => {},
  hideExtensionPet: async () => {},
  setExtensionPetHitRegion: async () => {},
  reportExtensionPetPosition: async () => {},
  reportExtensionPetInspection: async () => {},
...
export const createTauriApi = (): MoonSpriteApi => ({
  ...
  readExtensionPetSprite: (extensionId, petId) => invokeBytes('read_extension_pet_sprite', { extensionId, petId }),
  showExtensionPet: (extensionId, petId, bounds, summary) => invoke('show_extension_pet', { extensionId, petId, bounds, summary }),
  hideExtensionPet: () => invoke('hide_extension_pet'),
  setExtensionPetHitRegion: (sourceWidth, sourceHeight, spans) => invoke('set_extension_pet_hit_region', { sourceWidth, sourceHeight, spans }),
  reportExtensionPetPosition: (extensionId, petId) => invoke('report_extension_pet_position', { extensionId, petId }),
  reportExtensionPetInspection: (extensionId, petId) => invoke('report_extension_pet_inspection', { extensionId, petId }),
