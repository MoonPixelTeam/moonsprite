...
export type ImageExportFormat = 'png' | 'jpeg' | 'webp' | 'svg' | 'gif' | 'bmp' | 'ico' | 'psd' | 'mp4' | 'webm' | 'aseprite'

export type SaveDialogFormat = 'moonsprite' | 'png' | 'jpeg' | 'webp' | 'svg' | 'ico' | 'psd' | 'ase' | 'aseprite' | 'gif' | 'bmp'
