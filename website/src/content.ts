...
export interface Copy {
  ...
  work: { eyebrow: string; title: string; description: string; files: string[]; itemAlt: string[] }
...
export const copy: Record<Language, Copy> = {
  zh: {
    ...
    work: { eyebrow: '画廊 gallery/', title: '从微小图标，到完整世界。', description: '以下像素作品来自工程的 gallery/ 目录，用于展示不同尺度、色彩与构图下的像素表现。', files: ['moonlit-city.moonsprite', 'seaside-workshop.moonsprite', 'lunar-observatory.moonsprite'], itemAlt: ['MoonSprite 内置展示作品：月夜城市、海边工坊与月面基地组合', 'MoonSprite 内置展示作品：月夜海边工坊与灯塔', 'MoonSprite 内置展示作品：巨月下的未来观测城市'] },
    features: {
      eyebrow: 'FEATURES',
      title: '软件功能',
      description: '从画笔到脚本，MoonSprite 的核心能力一屏看全。',
      items: [
        { icon: 'pencil', title: '像素铅笔', body: '逐像素落笔，按住 Shift 从上一落点连接直线。' },
        { icon: 'airbrush', title: '喷枪', body: '粒子喷涂，大小、散布、密度与频率都可调整。' },
        { icon: 'selection', title: '选区与变换', body: '矩形、椭圆、套索、多边形与魔棒；移动、复制、翻转、缩放、旋转。' },
        { icon: 'shape', title: '形状与线条', body: '矩形、椭圆、多边形、像素直线与可实时调整的曲线。' },
        { icon: 'fill', title: '油漆桶与渐变', body: '连续区域一键填充，前景到背景的线性渐变。' },
        { icon: 'text', title: '文本图层', body: '可编辑文本图层，字体、字号、间距与渲染方式可调。' },
        { icon: 'layers', title: '图层系统', body: '普通层、背景层、图层组、蒙版与图层样式。' },
        { icon: 'film', title: '逐帧动画', body: '多帧时间轴，每帧独立时长，洋葱皮与动画循环节。' },
        { icon: 'colors', title: '颜色与调色板', body: 'RGBA 与索引颜色、前景背景色、自定义调色板与同步颜色。' },
        { icon: 'tiles', title: '瓦片工作流', body: '共享瓦片集的瓦片图层与自由摆放的自由瓦片图层。' },
        { icon: 'workspace', title: '工作区', body: '多项目标签、栏目停靠与悬浮、布局保存与多主题界面。' },
        { icon: 'export', title: '导出与切片', body: '精灵表、切片、GIF、缩时视频与 .moonsprite 工程。' },
        { icon: 'scripting', title: '脚本与扩展', body: '受限 Lua 5.4 沙箱、mse.* API 与 .msext 扩展包。' },
        { icon: 'windows', title: 'Windows 集成', body: '系统剪贴板、文件关联、资源管理器缩略图与恢复草稿。' },
      ],
    },
  ...
  en: {
    ...
    work: { eyebrow: 'Gallery', title: 'From tiny icons to complete worlds.', description: 'These pixel pieces ship in the project gallery/ directory to demonstrate different scales, palettes, and compositions.', files: ['moonlit-city.moonsprite', 'seaside-workshop.moonsprite', 'lunar-observatory.moonsprite'], itemAlt: ['MoonSprite showcase: moonlit city, seaside workshop, and lunar base triptych', 'MoonSprite showcase: a moonlit seaside workshop and lighthouse', 'MoonSprite showcase: a future observatory city under a giant moon'] },
    features: {
      eyebrow: 'FEATURES',
      title: 'Features',
      description: 'From brushes to scripting — the core capabilities of MoonSprite at a glance.',
      items: [
        ...
        { icon: 'selection', title: 'Selection and transform', body: 'Rectangle, ellipse, lasso, polygon, and magic wand; move, copy, flip, scale, rotate.' },
        { icon: 'shape', title: 'Shapes and lines', body: 'Rectangles, ellipses, polygons, pixel lines, and live-adjustable curves.' },
        { icon: 'fill', title: 'Fill and gradient', body: 'One-click flood fill and foreground-to-background linear gradients.' },
        { icon: 'text', title: 'Text layers', body: 'Editable text layers with font, size, spacing, and rendering controls.' },
        { icon: 'layers', title: 'Layer system', body: 'Regular layers, background layers, groups, masks, and layer styles.' },
        { icon: 'film', title: 'Frame animation', body: 'Multi-frame timeline with per-frame timing, onion skins, and loop sections.' },
        { icon: 'colors', title: 'Colors and palettes', body: 'RGBA and indexed color, foreground and background, custom palettes, and color sync.' },
        { icon: 'tiles', title: 'Tile workflow', body: 'Tile layers with shared tile sets and free tile layers with overlapping instances.' },
        { icon: 'workspace', title: 'Workspace', body: 'Project tabs, dockable and floating panels, saved layouts, and multiple themes.' },
        { icon: 'export', title: 'Export and slices', body: 'Sprite sheets, slices, GIFs, timelapse video, and .moonsprite projects.' },
        { icon: 'scripting', title: 'Scripting and extensions', body: 'A restricted Lua 5.4 sandbox, the mse.* API, and .msext extension packages.' },
        { icon: 'windows', title: 'Windows integration', body: 'System clipboard, file associations, Explorer thumbnails, and recovery drafts.' },
      ],
    },
